 ...
 * manipulating the list's pointer.
 */
public class LinkedList<T>
{
 ...
 /**
   ...
   */
   ...
   /**checks if the a character already exists
	 *@param obj the list with the frequencies 
	 *@param letter the character to be found
	 *@returns 1 if it exists and -1 if not
	 */
	public int exist(byte letter){
		this.reset();
		while(this.isAtEnd()!=true){			
			if (((HuffmanToken) this.currentData()).getLetter()==letter){
				return 1;
			}
			this.increment();
		}
